    ...
    try:
        ...
        result = {
            ...
            "weather": {
                ...
                "wind_kmh": round((w.get("wind", {}).get("speed") or 0) * 3.6, 1),
                "city": w.get("name"),
            }
        }
        return result
...
def api_air():
    ...
    primary = fetch_openweather_air(lat, lon)  # you added earlier
    if primary.get("ok"):
